...
namespace NotesService.API.DataAccess.Migrations
{
    ...
    [Migration("20240718121618_tableNames")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryNote", b =>
                {
                    b.HasOne("NotesService.API.DataAccess.Models.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NotesService.API.DataAccess.Models.Note", null)
                        .WithMany()
            ...
            modelBuilder.Entity("NotesService.API.DataAccess.Models.Note", b =>
                {
                    b.HasOne("NotesService.API.DataAccess.Models.MediaType", "MediaType")
                        .WithMany("Notes")
